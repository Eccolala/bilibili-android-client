...
/**
 * Designed by hcc on 2016/11/20 21:32
 *
 * <p>
 * API常量类
 */
...
public class ApiConstants {
    ...
    //bilibili 验证码 URL
    public static final String BILI_VERIFY_URL = "https://passport.bilibili.com/captcha";

    //验证码 URL , eg: http://ook0mwqpi.bkt.clouddn.com/image/jpg/1.jpg
    public static final String VERIFY_BASE_URL = "http://ook0mwqpi.bkt.clouddn.com/image/jpg/";
